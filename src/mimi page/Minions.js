        ...
        <>
            <div className='relative flex flex-col h-auto bg-white w-full overflow-x-hidden overflow-y-scroll scroll-m-0 pb-20'>
                ...
                <div className='relative z-10'>
                    ...
                    <div className='flex justify-center w-full mt-6 lg:mt-12 md:mt-6'>
                        <div className='w-[450px] h-[250px] scale-[70%] lg:scale-100 bg-black rounded-lg'>
                            <iframe width="450" height="250" className='rounded-lg' src="https://www.youtube.com/embed/6DxjJzmYsXo?si=v8Zn5zgFA3FnBRaY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
                    </div>
                        ...
                        <div className='lg:w-[650px] lg:scale-100'>
                            <div className='ml-[-5rem] lg:ml-0'>
                                ...
                                <div className='flex gap-6'>
                                    <div onClick={() => setOpenPopUp(true)} className=' bg-yellow-400 rounded-full hover:bg-yellow-500 border-[12px] mt-10 border-white px-5 py-5 shadow-inner cursor-pointer'>
                                        <FaPlay className='text-white cursor-pointer' />
                                    </div>
                                    <h2 className='text-xs lg:text-sm font-bold mt-14'>WATCH TRAILER</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='w-[300px] lg:w-[650px]'>
                            <div className='pl-6 sm:pl-16 lg:pl-28'>
                                ...
                                <div className='flex lg:gap-6 gap-3'>
                                    ...
                                    <h2 className='text-xs lg:text-sm font-bold mt-16'>WATCH TRAILER</h2>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id='bob' className='-mt-36 lg:mt-24 flex justify-between scale-[80%] lg:scale-100'>
                        ...
                        <div className=' lg:w-[650px] lg:scale-100'>
                            <div className='ml-[-5rem] lg:ml-0'>
                                ...
                                <div className='flex gap-6'>
                                    <div onClick={() => setOpenPopUp(true)} className=' bg-yellow-400 cursor-pointer rounded-full hover:bg-yellow-500 border-[12px] mt-10 border-white px-5 py-5 shadow-inner'>
                                        <FaPlay className='text-white cursor-pointer' />
                                    </div>
                                    <h2 className='text-xs lg:text-sm font-bold mt-14'>WATCH TRAILER</h2>
                                </div>
                ...
                <div className='absolute h-[300px] lg:h-[570px] w-full px-10 -skew-y-3 top-[32rem] sm:top-[39rem] lg:top-[60rem] bg-yellow-400'></div>
                <div className='absolute h-[350px] sm:h-[420px] lg:h-[200px] w-full skew-y-3 px-[90px] top-[45rem] lg:top-[90rem] bg-yellow-400'></div>


                <div className='absolute h-[200px] lg:h-[470px] w-full px-10 -skew-y-3 top-[93rem] sm:top-[100rem] lg:top-[140rem] bg-yellow-400'></div>
                <div className='absolute h-[335px] sm:h-[300px] lg:h-[270px] w-full skew-y-3 px-[90px] top-[100rem] sm:top-[110rem] lg:top-[164rem] bg-yellow-400'></div>
            </div>
            {
                openPopUp && <div id='popupBlock' onClick={handleOnClose} className='fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex items-center justify-center z-[100]'>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/6DxjJzmYsXo?si=v8Zn5zgFA3FnBRaY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            }
        </>
    )
